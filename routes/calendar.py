...
def events():
    ...
    try:
        ...
        start_date = datetime.today().date() - timedelta(days=30)   # Show from 1 month ago
        end_date = datetime.today().date() + timedelta(days=30)    # Show 1 month ahead
...
def attendance_report():
    ...
    for user_report in all_user_reports:
        ...
        formatted_report = {
            ...
            'attendance_records': user_report.attendance_records, # Corrected from report_data
            'leave_requests': user_report.leave_requests, # Added
            'permission_requests': user_report.permission_requests # Added
        }
